...
namespace YourLedger.Functions
{
    ...
    public class CryptoUpdater : ICloudEventFunction<MessagePublishedData>
    {
        private readonly IStorageService<UserCrypto> _storageService;
        private readonly IDataProcessor<CryptoMessage, UserCrypto> _dataProcessor;
       ...
       public async Task HandleAsync(CloudEvent cloudEvent, MessagePublishedData data, CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                UserCrypto updatedUserData;
                var fileName = $"{request.UserId}/{request.CapturedStockData.Data.FromCurrencyName}";
